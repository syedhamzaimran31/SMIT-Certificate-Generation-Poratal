...
function IssuedCertificateForm() {
    const {issuedBatchNo, setIssuedBatchNo,error,issuedCourseName, setIssuedCourseName}=useGlobalState()
    return (
        <>
            <div className="mt-4">
                <div className="mb-3">
...
export default memo(IssuedCertificateForm)